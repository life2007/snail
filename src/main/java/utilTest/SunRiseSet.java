...
//        Log.d("Sunset", "Sunset is: "+(int)(sunset/15+8)+":"+(int)(60*(sunset/15+8-(int)(sunset/15+8)))+" .\n");
    ...
    public static void main(String[] args) {
        String str1 = SunRiseSet.getSunrise(new BigDecimal(116.46),new BigDecimal(39.92),new Date(2018,11,30));
        String str2 = SunRiseSet.getSunset(new BigDecimal(116.46),new BigDecimal(39.92),new Date(2018,11,30));
